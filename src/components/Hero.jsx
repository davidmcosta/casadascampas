        ...
        <div className="max-w-full sm:max-w-3xl md:max-w-4xl lg:max-w-5xl xl:max-w-6xl">
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 md:gap-4 lg:gap-5 animate-fadeInUp delay-400">
            <Link
              ...
              aria-label="Explore our funeral monuments and memorial products"
            >
              <span className="flex-1 text-center sm:text-left">{hero.ButtonText}</span>
              <ArrowRightIcon />
            </Link>
            ...
            >
              <span className="flex-1 text-center sm:text-left">{hero.secondaryButtonText}</span>
